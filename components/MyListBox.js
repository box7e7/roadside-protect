...
let locationType=["Highway","Home Driveway","Home Garage","Parking Garage","Parking Lot"]
...
useEffect(()=>{
  ...
  return (
  <>
    <SelectBox selected={selected} setSelected={setSelected} arrayObj={locationType}/>
