    ...
    return (
        <div>
            ...
            <div>
                ...
                {/* Question 2 */}
                <div className='pt-5 pb-5'>What type of fuel do you need?</div>
                <div className='flex items-center justify-center space-x-4'>
                    <button name="q2" value="yes" className='pt-3 rounded border border-slate-300 w-24 h-10 flex justify-center items-center py-3' onClick={(e)=>toggleButton(e,"q2",state,setState)}>Gasoline</button>
                    <button name="q2" value="no" className='pt-3 rounded border border-slate-300 w-24 h-10 flex justify-center items-center py-3'  onClick={(e)=>toggleButton(e,"q2",state,setState)}>Diesel</button>
                </div>
                </div>
             ...
             <div className='w-full flex items-center justify-center py-10'>
                    <Button pill={true} className='w-[70%] font-bold' onClick={()=>{
                        if(state.q1 && state.q2 && !selected.includes("Select")){
