...
export default  function UnlockQuestions(){
    ...
    return (
        <div>
            ...
            <div>
                ...
                {/* Question 2 */}
                <div className='pt-5 pb-5'>Are the keys locked in the vehicle?</div>
                <div className='flex items-center justify-center space-x-4'>
                ...
                {/* Question 3 */}
                <div className='pt-5 pb-5'>Are the keys missing or Broken?</div>
                <div className='flex items-center justify-center space-x-4'>
